...
import { getWeatherDescription, getUpcomingHours, type HourlyForecast } from "@/services/weather";
...
export async function POST(req: NextRequest) {
  const { weather, prefs }: {weather: any; prefs: Preferences } = await req.json();
